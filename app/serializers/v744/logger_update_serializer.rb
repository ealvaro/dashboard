class V744::LoggerUpdateSerializer < V730::UpdateSerializer
  attributes :block_height, :hookload, :bore_pressure, :annular_pressure, :pump_pressure, :bit_depth, :weight_on_bit, :rotary_rpm, :rop, :voltage, :inc,
             :azm, :api, :hole_depth, :gravity, :grav_roll, :mag_roll, :dipa, :survey_md, :survey_tvd, :survey_vs, :temperature,
             :pumps_on, :on_bottom, :slips_out, :gama, :gamma_shock, :gamma_shock_axial_p, :gamma_shock_tran_p, :decode_percentage, :magf,
