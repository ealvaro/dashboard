class V730::ReceiverUpdateSerializer < V730::UpdateSerializer
  attributes :block_height, :hookload, :bore_pressure, :annular_pressure, :pump_pressure, :bit_depth, :weight_on_bit, :rotary_rpm, :rop, :voltage, :inc, :azm, :api,
             ...
             :com3, :com6, :pumps_on, :on_bottom, :slips_out, :livelog, :dao, :reporter_version, :decode_percentage, :pump_on_time, :pump_off_time,
