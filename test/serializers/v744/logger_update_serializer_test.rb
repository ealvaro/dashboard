...
class V744::LoggerUpdateSerializerTest < ActiveSupport::TestCase
  test "should be fixed to only these parameters" do
    ...
    logger = %i(annular_pressure api atfa average_quality ax ay az azm
             batv batw bit_depth block_height bore_pressure
             ...
             hole_depth hookload inc mag_roll magf mtfa mx my mz
    ...
    json = V744::LoggerUpdateSerializer.new(actual, root: false).as_json
